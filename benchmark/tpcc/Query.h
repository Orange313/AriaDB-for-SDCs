...
namespace aria
{
  namespace tpcc
  {
    ...
    struct NewOrderQuery
    {
      ...
      SDC_Choice SDC_record = SDC_Choice::DEFAULT;
    ...
    int32_t sdc_get_value_neworder(NewOrderQuery query){
      switch (query.SDC_record){
        case SDC_Choice::D_ID:
          return query.D_ID;
        case SDC_Choice::C_ID:
          return query.C_ID;
    ...
    int32_t sdc_get_value_payment(PaymentQuery query){
      switch (query.SDC_record){
        case SDC_Choice::D_ID:
          return query.D_ID;
        case SDC_Choice::C_ID:
