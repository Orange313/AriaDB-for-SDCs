...
input_csv = 'error_detection\data\original\A\log01.csv' 
output_csv = 'error_detection\data\original\A\log01a.csv'
log_file = 'error_detection\data\sdc_log\log01_sdc.csv'
